...
if [ ! -z "$2" ]
    ...
    if [ ! -f ~/.android/debug.keystore ]; then
      ...
      keytool -genkey -v -keystore ~/.android/debug.keystore -storepass android -alias androiddebugkey -keypass android -keyalg RSA -keysize 2048 -deststoretype pkcs12 -validity 10000
    fi
